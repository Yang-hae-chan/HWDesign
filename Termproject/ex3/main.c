    ...
    *(PS2_ptr + 1) =
    ...
    while (1) {
        ...
        if(byte3 !=0&&byte2!=0){
            ...
            printf("\nindex:%d, input:%c",index,input[index]);
        }
...
void HEX_PS2(char b1, char b2, char b3) {
    ...
    char s;
    if (b3 == 0x69) {s = '1';input[++index]='1';}
    if (b3 == 0x72) {s = '2';input[++index]='2';}
    if (b3 == 0x7A) {s = '3';input[++index]='3';}
    if (b3 == 0x6B) {s = '4';input[++index]='4';}
    if (b3 == 0x73) {s = '5';input[++index]='5';}
    if (b3 == 0x74) {s = '6';input[++index]='6';}
    if (b3 == 0x6C) {s = '7';input[++index]='7';}
    if (b3 == 0x75) {s = '8';}
    if (b3 == 0x7D) {s = '9';input[++index]='9';}
    if (b3 == 0x70) {s = '0';input[++index]='0';}
    ...
    if (b3 == 0x5A) {clear_char_all();clear_input(); return;}
    if (b3 == 0x66) {clear_char(); return;}               
    if (b3 == 0x1C) {ss='=';print();
                    printf("\nans: %d",calc(input));
                    ss= (char)(calc(input)) + 0x30; 
                    print();
                    index=-1; return;}
    ss=s;
    print();
